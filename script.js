...
async function updateGridWithLiveStatus() {
    try {
        // Fetch the file generated by GitHub Actions (with an added timestamp to prevent old caching)
...
// Keep client UI synced by re-fetching the updated static file every 60 seconds
